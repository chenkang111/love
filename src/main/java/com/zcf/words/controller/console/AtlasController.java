...
public class AtlasController {
    ...
    @RequestMapping("add")
    public boolean add(@RequestBody Atlas atlas) {
        return this.atlasservice.add(atlas);
    }

    @RequestMapping("delete")
    public boolean delete(@RequestParam Integer id) {
        return this.atlasservice.delete(id);
    }

    @RequestMapping("update")
    public boolean update(@RequestBody Atlas atlas) {
        return this.atlasservice.update(atlas);
    }

    @RequestMapping("query")
    public LayUiResult queryAtlas(@RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "20") Integer limit) {
        return this.atlasservice.query(page,limit);
    }

    @RequestMapping("search")
    public LayUiResult search(@RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "20") Integer limit,
        @RequestParam String keywords){
        return this.atlasservice.search(page,limit,keywords);
    }
