...
import com.zcf.words.service.CodeService;
...
public class CodeController {
    ...
    @RequestMapping("add")
    public boolean add(@RequestBody Code code) {
        return this.codeservice.add(code);
    }
    ...
    public boolean update(@RequestBody Code code) {
        return this.codeservice.update(code);
    }

    @RequestMapping("query")
    public LayUiResult queryCode(@RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "20") Integer limit) {
        return this.codeservice.query(page,limit);
    }

    @RequestMapping("search")
    public LayUiResult search(@RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "20") Integer limit,
        @RequestParam String keywords) {
        return this.codeservice.search(page,limit,keywords);
    }
