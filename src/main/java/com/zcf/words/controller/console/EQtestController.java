...
public class EQtestController {
    ...
    @RequestMapping("add")
    public boolean add(@RequestBody EQtest EQtest) {
        return this.EQtestservice.add(EQtest);
    }

    @RequestMapping("delete")
    public boolean delete(@RequestParam Integer id) {
        return this.EQtestservice.delete(id);
    }

    @RequestMapping("update")
    public boolean update(@RequestBody EQtest EQtest) {
        return this.EQtestservice.update(EQtest);
    }

    @RequestMapping("query")
    public LayUiResult queryEQtest(@RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "20") Integer limit) {
        return this.EQtestservice.query(page,limit);
    }

    @RequestMapping("search")
    public LayUiResult search(@RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "20") Integer limit,
        @RequestParam String keywords) {
        return this.EQtestservice.search(page,limit,keywords);
    }
